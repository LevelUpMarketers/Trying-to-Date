...
class TTA_Comms_Admin {
    ...
    public static function get_default_templates(){
        return [
            ...
            'membership_purchase' => [
                'label'       => __( 'New Membership Purchase', 'tta' ),
                'type'        => 'External',
                'category'    => 'Membership',
                'description' => __( 'Sent when a member successfully purchases a membership.', 'tta' ),
                'email_subject' => __( 'Welcome to your membership!', 'tta' ),
                'email_body'  => __( 'Thanks for becoming a {membership_level} member. You now have access to member benefits. Manage your membership anytime from your dashboard.', 'tta' ),
                'sms_text'    => '',
            ],
            'membership_cancellation' => [
                'label'       => __( 'Membership Cancellation', 'tta' ),
                'type'        => 'External',
                'category'    => 'Membership',
                'description' => __( 'Sent when a member cancels their membership.', 'tta' ),
                'email_subject' => __( 'Your membership has been cancelled', 'tta' ),
