...
class TTA_Venues_Admin {
    ...
    public function register_menu(){
        add_menu_page('TTD Venues','TTD Venues','manage_options','tta-venues',[ $this,'render_page' ],'dashicons-location-alt',9.8);
    }
    public function render_page(){
        $tabs = [ 'create'=>'Add Venue','manage'=>'Manage Venues' ];
        $current = isset($_GET['tab']) && isset($tabs[$_GET['tab']]) ? $_GET['tab'] : 'create';
        echo '<h1>TTD Venues</h1><h2 class="nav-tab-wrapper">';
